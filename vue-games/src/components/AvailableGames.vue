      ...
      <div class="row">
        <div class="col-md-6 mt-5">
            <div class="image-container d-flex justify-content-center align-items-center">
              <img src="../../public/images/piotr-laskawski-gL7oJLJOb_I-unsplash.jpg" alt="Anagram Hunt Thumbnail" class="rounded-3" width="250"/>
            </div>
        </div>
        ...
        <div class="row mb-5">
          <div class="col-md-6 mt-5">
            <div class="image-container d-flex justify-content-center align-items-center">
              <img src="../../public/images/chris-liverani-ViEBSoZH6M4-unsplash.jpg" alt="Math Facts Thumbnail" class="rounded-3" width="250" />
            </div>
          </div>
          <div class="col-md-6 mt-3 my-md-5">
            <div class="d-flex flex-column justify-content-center align-items-center">
